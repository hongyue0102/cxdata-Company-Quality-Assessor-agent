# 管理层及关联人持股变动-通用 (getDComManHoldstkChanByCond-G)

**API_ID:** getDComManHoldstkChanByCond-G
...
| leadName | 董监高姓名 | 字符类型 | 否 |  |
| stkChanName | 股份变动人名称 | 字符类型 | 否 |  |
...
| CHAN_DATE | 变动日期 | 日期类型 |
| REP_DATE | 填报日期 | 日期类型 |
| LEAD_NAME | 董监高姓名 | 字符类型 |
| POSI_NAME | 董监高职务 | 字符类型 |
| STK_CHAN_NAME | 股份变动人名称 | 字符类型 |
| LEAD_RELA | 股份变动人与董监高关系 | 字符类型 |
