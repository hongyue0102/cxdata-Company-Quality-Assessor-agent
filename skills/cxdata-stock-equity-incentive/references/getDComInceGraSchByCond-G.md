# 公司股权激励实施安排表-通用 (getDComInceGraSchByCond-G)

**API_ID:** getDComInceGraSchByCond-G
...
| PER_ARRA | 期次安排 | 字符类型 |
| STAR_END_DATE | 本期起止时间 | 字符类型 |
| CONF_RATIO | 本期权益占比 | 数值类型 |
...
2. 调用 **公司股权激励实施安排表-通用（API_ID:getDComInceGraSchByCond-G）**，完成当前查询
