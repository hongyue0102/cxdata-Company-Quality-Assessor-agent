# 公司股权激励人数变动表-通用 (getDComInceObjByCond-G)

**API_ID:** getDComInceObjByCond-G
...
| DECL_DATE | 公告日期 | 日期类型 |
| INC_OBJ_NUM | 激励对象总人数 | 数值类型 |
| PROP_RATIO | 占公司员工总数比例 | 数值类型 |
| INC_OBJ_DESC | 激励对象说明 | 字符类型 |
...
2. 调用 **公司股权激励人数变动表-通用（API_ID:getDComInceObjByCond-G）**，完成当前查询
